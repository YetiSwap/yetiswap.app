                            ...
                            <div className="col-lg-6 col-md-10">
                                <div className="d-flex mb-10 mb-lg-17">
                                    ...
                                    <div className="">
                                        ...
                                        <p className="font-size-5 pr-md-10 pr-lg-0 mb-0">
                                            If you have a pending transaction that has not finalized, you can try the following steps <a class="hover:no-underline" href="https://support.avalabs.org/en/articles/4872721-metamask-transactions-are-stuck-rejected">here</a>.
                                        </p>
                                    </div>
                                </div>
                            </div>
